...
// Validate ../../src/app/(workspace)/library/page.tsx
{
  type __IsExpected<Specific extends AppPageConfig<"/library">> = Specific
  const handler = {} as typeof import("../../src/app/(workspace)/library/page.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
...
// Validate ../../src/app/(workspace)/workflow/page.tsx
{
  type __IsExpected<Specific extends AppPageConfig<"/workflow">> = Specific
  const handler = {} as typeof import("../../src/app/(workspace)/workflow/page.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
